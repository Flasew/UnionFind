 ...
 * 
 * Authors:
 * Hong Rui Zhang A14090079
 * Weiyang Wang A13690637
 * 
 * Date: 2017-11-30
 *
 * A very general implementation of the UnionFind data structure, intended for 
 * future usage. Uses union by size and path compression for optimization.
 */
